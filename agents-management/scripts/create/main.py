...
(or ``$OPENFUSED_APP_DIR_STATE/agents``). Mirrors ``createAgent`` in
``app/src/server/store/roster.ts``: required-field + slug-collision rules, slug
derived from the name, ``builtin: false``.
