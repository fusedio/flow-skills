"""Read UDF — whether a synthetic feedback id is in ``dismissedFeedbackKeys``.
...
------
id : str
    The synthetic feedback id to check. Empty string is never dismissed.

Returns
-------
bool
    ``True`` iff ``id`` is present in ``dismissedFeedbackKeys``.
"""
